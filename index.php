...
<body>
    ...
    <section class="hero">
        <h1>Welcome to the Community Complaint System</h1>
    ...
    <section class="about" id="about">
        <h2>About Us</h2>
        <p>The Community Complaint System aims to create a streamlined process for resolving issues in your neighborhood.</p>
    </section>

    <footer>
        <p>&copy; 2025 Community Complaint System. All rights reserved.</p>
        <p>Contact us at <a href="mailto:contact@communitysystem.com">contact@communitysystem.com</a></p>
    </footer>
</body>
</html>
